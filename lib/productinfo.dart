          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1.2,
                  child: Image.asset('assets/images/vitc.png'),
                ),
              ],
            ),
            Positioned(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                        color: RevellTheme.grey.withOpacity(0.2),
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              'DHC Supplement Vitamin C \60 Days',
                                    ...
                                    children: <Widget>[
                                      Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          fontSize: 22,
                                          letterSpacing: 0.27,
                                          color: RevellTheme.grey,
                                        ),
                                      ),
                                      Icon(
                                        Icons.star,
                                        color: RevellTheme.nearlyBlue,
                                        size: 24,
                                      ),
                                    ],
                                  ),
